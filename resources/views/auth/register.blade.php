<x-layouts.main :header="false" bodyWrapper="font-body-md text-on-surface flex flex-col relative"
    ...
    <div class="glass-card w-full max-w-[480px] p-8 md:p-12 rounded-xl flex flex-col items-center">
        <!-- Brand Identity -->
        <x-brand />
        <!-- Typography Header -->
        <div class="text-center mb-10">
            <h1 class="font-headline-lg text-headline-lg text-on-surface mb-2">Join the Sanctuary</h1>
            <p class="font-body-md text-body-md text-on-surface-variant">Begin your creative journey</p>
        </div>
        <!-- Sign Up Form -->
        <form class="w-full space-y-6" method="POST" action="{{ route('register') }}">
            ...
            <div class="space-y-2">
                ...
                <div class="relative inner-glow">
                    <input name="name"
                        class="w-full bg-surface-container-lowest/50 border border-outline-variant/30 rounded-lg px-4 py-3 text-on-surface placeholder:text-on-surface-variant/40 focus:border-primary focus:ring-0 transition-all duration-300"
            ...
            <!-- Action Button -->
            <button
                class="btn-glow w-full bg-primary-container text-on-primary-container font-headline-lg text-[16px] py-4 rounded-lg font-bold transition-all duration-300 active:scale-95 flex items-center justify-center gap-2"
                type="submit">
                Create Account
        ...
        <div class="mt-10">
            <p class="font-body-md text-body-md text-on-surface-variant">
                ...
                <a href="{{ route('login') }}"
                    class="text-primary hover:text-secondary font-medium transition-colors underline underline-offset-4 decoration-primary/20 hover:decoration-secondary">Sign
                    in</a>
            </p>
        </div>
    </div>
